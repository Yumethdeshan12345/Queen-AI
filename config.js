...
module.exports = {
      ...
      SESSION_ID: process.env.SESSION_ID || "QUEEN-AI;;;SkaaraRoped", //enter your session id here
      OWNER_NUMBER: process.env.OWNER_NUMBER || "94764186258", //Owner whatsapp number here
      OWNER_NAME: process.env.OWNER_NAME || "Cipher", //Queen-AI Owner Name here
